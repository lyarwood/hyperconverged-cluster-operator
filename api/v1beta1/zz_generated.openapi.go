				...
				Properties: map[string]spec.Schema{
					...
					"CommonInstancetypesDeployment": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kubevirt/hyperconverged-cluster-operator/api/v1beta1.CommonInstancetypesDeployment"),
						},
					},
				},
			},
